        ...
        {criticalTasks.length === 0 ? (
          ...
          criticalTasks.map((task) => {
            ...
            return (
              <div
                key={task.id}
                className="bg-white/60 dark:bg-gray-700/60 rounded-xl p-4 border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200"
              >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`text-sm font-medium ${getStatusColor(taskStatus)}`}>
